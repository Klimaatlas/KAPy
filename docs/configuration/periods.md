...
- <a id="properties/id"></a>**`id`** *(string, required)*: Unique identifier for the period. This can be numeric, but will be treated as a string. Cannont contain space or comma. Must match pattern: `^[^ ,]+$` ([Test](https://regexr.com/?expression=%5E%5B%5E%20%2C%5D%2B%24)). Items must be unique.
...
- <a id="properties/description"></a>**`description`** *(string, required)*: Description/name of the period. Stored in the output database.
